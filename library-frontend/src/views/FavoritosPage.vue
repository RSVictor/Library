...
<div class="container">
  ...
  <div class="card-fav mt-5">
    <a href="descricaolivros.html">
      <img src="C:\Users\Victor\Desktop\Biblioteca_Victor\library-frontend\src\assets\img\Arquitetura Limpa.png" class="card-img-top mt-2" alt="Livro favorito">
    </a>
...
.bd-placeholder-img {
    width: 140px;
    /* Largura fixa das imagens */
    height: 140px;
    /* Altura fixa das imagens */
...
.rounded-circle {
    border-radius: 50%;
    /* Arredonda as imagens para se tornarem circulares */
}
...
.descricao div {
    flex: 1;
    /* Permite que os itens cresçam igualmente */
}
...
.lista-adm{
    ...
    border-radius: 10px;     
    background-color: #C3C4C9;
    column-gap: 10px; /* Espaço entre as colunas (opcional) */
...
.button-excluir-adm {
  ...
  .text-lista{
    width: 155.27px; /* Largura fixa da div */
    height: 70px; /* Altura fixa da div */
    max-height: 70px; /* Altura máxima da div */
...
.titulo-adm-button-lista i{
    color: white;
}


/* Pagina Adicionar livros*/
