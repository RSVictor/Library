...
router.delete('/:id', async (req, res) => {
    try {
        console.log('Tentando excluir livro com ID:', req.params.id);
        ...
        if (book.image) {
            ...
            console.log('Deletando imagem do livro:', filePath);
        ...
        console.log('Livro excluído com sucesso:', req.params.id);
